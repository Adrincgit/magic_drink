...
import { INTERVIEW_ENTRY, INTERVIEW_JOURNEY_END } from './hexyInterviewTiming';
export const JOURNEY_END = INTERVIEW_JOURNEY_END;
export const journeyChapters = [
  ...
  { at: .92, from: .86, es: 'UN LUGAR PARA LA MAGIA', en: 'A PLACE FOR THE MAGIC' },
  { at: INTERVIEW_ENTRY, from: 2.5, es: 'HEXY RESPONDE', en: 'HEXY ANSWERS' },
];
