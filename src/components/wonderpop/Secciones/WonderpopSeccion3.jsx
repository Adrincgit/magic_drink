...
const content = {
    ...
    zones: [
      {
        ...
        title: 'Tienda Oficial de Magic Drink',
        desc: 'Magic Drink y sus productos oficiales, en el corazón de la plaza. Acércate a las estaciones de degustación y comparte tu momento.',
        tag: 'Flagship',
        color: '#FF6AD7',
        featured: false,
      },
      ...
      },
      {
        ...
        desc: 'Meet & greets virtuales con Hexy, pop-ups temáticos y colaboraciones con artistas locales. Siempre hay algo nuevo alrededor de Magic Drink.',
        tag: 'Temporal',
        color: '#F9F871',
        featured: true,
  ...
  en: {
    ...
    zones: [
      {
        icon: '/icons/icono_lata.webp',
        title: 'Official Magic Drink Store',
        desc: 'Magic Drink and official merchandise, at the heart of the plaza. Visit the tasting stations and share your moment.',
        tag: 'Flagship',
        color: '#FF6AD7',
        featured: false,
      },
      ...
      },
      {
        ...
        desc: 'Virtual meet & greets with Hexy, themed pop-ups, and collaborations with local artists. There\'s always something new around Magic Drink.',
        tag: 'Temporary',
        color: '#F9F871',
        featured: true,
        image: '/image/wonderpop/wonderpop-interior.webp',
