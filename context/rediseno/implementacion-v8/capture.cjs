...
(async () => {
  const folder = path.resolve('context/rediseno/implementacion-v8/capturas');
 ...
 ['festival','[data-runway]',.49], ['join-060','[data-runway]',.60], ['join-062','[data-runway]',.62], ['plaza','[data-runway]',.68], ['plaza-near','[data-runway]',.735], ['door','[data-runway]',.8], ['interior','[data-runway]',.878], ['original','[data-runway]',1],
 ];
